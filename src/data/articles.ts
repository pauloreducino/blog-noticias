...
export const articles: Article[] = [
  {
    ...
    title:
      "Governo do MA lança plano habitacional para São Luís com 10 mil unidades até 2026",
    excerpt:
      "Pacote prevê construção de 10 mil unidades habitacionais em São Luís e municípios do interior, com investimento de R$ 2,3 bilhões provenientes de parceria federal.",
...
<p>A primeira fase das obras tem início previsto para março de 2025, com a construção de 2.500 unidades no Coroadinho. A entrega das primeiras casas está programada para o segundo semestre de 2025.</p>`,
    ...
    author: {
      ...
      slug: "carla-mendonca",
      avatar:
        "https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=200&q=80&fit=crop&crop=face",
      role: "Editora-Chefe",
    },
  ...
  },
  {
    ...
    title:
      "Lençóis Maranhenses recebe nova certificação internacional de conservação ambiental",
    excerpt:
      "Parque Nacional dos Lençóis Maranhenses foi reconhecido por organismo internacional como um dos 50 ecossistemas mais preservados do planeta.",
...
<blockquote>Esta certificação não é apenas um prêmio. É uma responsabilidade para que continuemos protegendo este patrimônio natural que pertence ao Brasil e ao mundo.</blockquote>`,
  ...
  },
  {
    ...
    title:
      "Desemprego em São Luís cai pelo segundo trimestre consecutivo e atinge menor taxa em 7 anos",
    excerpt:
      "Taxa de desocupação na capital maranhense chegou a 11,2% no primeiro trimestre de 2025, queda de 2,4 pontos percentuais em relação ao mesmo período do ano anterior.",
...
<p>Apesar da melhora nos indicadores, economistas alertam que a informalidade ainda é elevada em São Luís. Cerca de 43% dos trabalhadores da cidade ainda atuam sem carteira assinada, percentual acima da média nacional de 38%.</p>`,
  ...
  },
  {
    ...
    title:
      "Bumba-meu-boi 2025: programação completa com 120 grupos e shows no Sambódromo de São Luís",
    excerpt:
      "Festa mais importante do Maranhão terá 45 dias de apresentações gratuitas distribuídas em 18 arraiais da capital, com início previsto para 1º de junho.",
...
<blockquote>O Bumba-meu-boi é a alma do Maranhão. Esta edição vai mostrar ao mundo que nossa cultura é viva, pulsante e capaz de emocionar qualquer pessoa.</blockquote>`,
  ...
  },
  {
    ...
    title:
      "UFMA abre inscrições para 14 novos cursos de pós-graduação gratuitos em 2025",
    excerpt:
      "Universidade Federal do Maranhão oferece 840 vagas em novos programas de especialização nas áreas de saúde, tecnologia, direito e gestão pública.",
...
<p>As inscrições estão abertas até 31 de março de 2025, pelo portal posgraduacao.ufma.br. Os candidatos devem ter diploma de graduação em qualquer área e apresentar documentação completa. A seleção será feita por análise de currículo e, em alguns cursos, entrevista.</p>`,
    ...
    readTime: 4,
    imageUrl:
      "https://images.unsplash.com/photo-1427504494785-405a60e2e2c0?w=1200&q=80",
  ...
  },
  {
    ...
    title:
      "Sampaio Corrêa anuncia três reforços para a disputa da Série C do Brasileirão 2025",
    excerpt:
      "Tricolor Maranhense fecha com atacante revelado pelo Fluminense, volante experiente e zagueiro para a campanha na terceira divisão nacional.",
...
<p>O presidente do Sampaio, em entrevista coletiva no CT Pedra Branca, afirmou que o objetivo da temporada é o acesso à Série B. O clube investiu cerca de R$ 3,2 milhões nas contratações, o maior investimento do clube em muitos anos.</p>`,
  ...
  },
  {
    ...
    title:
      "Startup maranhense de agritech levanta R$ 5 milhões em rodada seed para expansão nacional",
    excerpt:
      "A AgroMA, plataforma de gestão agrícola fundada em São Luís, recebeu aporte de fundo de venture capital paulista e prevê dobrar equipe em 2025.",
...
<p>Com o novo aporte, a empresa planeja expandir para mais seis estados até o final de 2025, contratar 40 novos funcionários e lançar um módulo de previsão climática por IA. A sede permanecerá em São Luís, no Hub de Inovação do Parque Tecnológico do Maranhão.</p>`,
  ...
  },
  {
    ...
    title:
      "Temperatura em São Luís bate recorde histórico para março com 38,7°C nesta semana",
    excerpt:
      "Inmet registrou a maior temperatura já medida no mês de março em São Luís desde o início das medições, em 1961. Especialistas alertam para riscos à saúde.",
...
<p>A Secretaria Municipal de Saúde emitiu alerta para a população, especialmente idosos, crianças e pessoas com doenças respiratórias ou cardiovasculares. As recomendações incluem evitar exposição solar entre 10h e 16h, aumentar a ingestão de água e buscar locais arejados.</p>`,
  ...
  },
  {
    ...
    title:
      "Viaduto do Maracanã começa a ser construído e promete reduzir em 40% os congestionamentos",
    excerpt:
      "Obra avaliada em R$ 187 milhões terá 1,2 km de extensão e conectará o corredor Maracanã ao Arame, liberando o trânsito em uma das regiões mais críticas de São Luís.",
...
<p>A obra tem previsão de conclusão para dezembro de 2026, com investimento de R$ 187 milhões, sendo R$ 120 milhões do governo federal (PAC Cidades) e R$ 67 milhões da Prefeitura de São Luís. Durante as obras, algumas vias auxiliares serão afetadas — a SEMOSP divulga rotas alternativas em seu site.</p>`,
    ...
    imageAlt: "Obras de viaduto em cidade",
  ...
  },
  {
    ...
    title:
      "Hospital Municipal de São Luís inaugura nova ala com 40 leitos de UTI e equipamentos modernos",
    excerpt:
      "Investimento de R$ 28 milhões na ampliação do Hospital Municipal vai reduzir tempo de espera por leitos de terapia intensiva na capital maranhense.",
