      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
          ...
          <div className="lg:col-span-2 space-y-10">
            ...
            <div className="rounded-2xl border border-cyan/15 bg-surface p-8 text-center">
              <p className="font-mono text-[10px] tracking-widest uppercase text-cyan mb-2">Faça parte da equipe</p>
              <h2 className="font-headline font-bold text-text-primary text-2xl mb-3">
                Quer escrever para o São Luís em Foco?
              </h2>
              <p className="font-body text-text-secondary leading-relaxed max-w-lg mx-auto mb-6">
          ...
          <aside className="space-y-6">
            ...
            <div className="bg-surface rounded-2xl border border-white/5 p-5">
              ...
              <div className="space-y-2">
                {[
                  { name: 'Instagram', handle: '@saoluisemfoco', followers: '12,4k', color: '#E1306C' },
                  { name: 'Twitter/X', handle: '@saoluisfoco', followers: '8,1k', color: '#1DA1F2' },
                  { name: 'YouTube', handle: 'São Luís em Foco', followers: '4,2k', color: '#FF0000' },
                  { name: 'Facebook', handle: 'São Luís em Foco', followers: '23k', color: '#1877F2' },
                ].map((s) => (
                  <a
                    key={s.name}
                    href="#"
                    className="flex items-center justify-between px-3 py-2.5 rounded-xl bg-elevated border border-white/5 hover:border-white/15 transition-colors group"
                  >
                    <div>
                      <p className="font-body text-sm font-medium text-text-secondary group-hover:text-text-primary transition-colors">
                        {s.name}
                      </p>
                      <p className="font-mono text-[10px] text-text-muted">{s.handle}</p>
                    </div>
                    <span className="font-headline font-bold text-sm" style={{ color: s.color }}>
                      {s.followers}
                    </span>
                  </a>
                ))}
