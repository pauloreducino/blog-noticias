...
export function Footer() {
  ...
  return (
    <footer
      className="bg-surface border-t border-cyan/15 mt-16"
      role="contentinfo"
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            <Link href="/" className="flex items-center gap-2 mb-4 group w-fit">
              ...
              <div className="leading-none">
                <div className="font-headline font-bold text-text-primary text-xl tracking-tight">
                  São Luís
                </div>
            ...
            <p className="font-body text-text-muted text-sm leading-relaxed mb-5">
              O portal de notícias mais completo de São Luís e do Maranhão.
              Informação rápida, precisa e relevante para o maranhense.
            </p>
          ...
          {/* Col 2 – Categorias A */}
          <div>
            <h3 className="font-mono text-[10px] tracking-widest uppercase text-text-muted mb-4">
              Categorias
            </h3>
          ...
          <div>
            ...
            <p className="font-body text-sm text-text-muted leading-relaxed mb-4">
              Receba as principais notícias de São Luís diretamente no seu
              e-mail.
            </p>
