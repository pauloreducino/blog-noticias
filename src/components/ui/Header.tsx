    ...
    <>
          ...
          <div className="ticker-track overflow-hidden flex-1">
            <div className="ticker-inner flex gap-12 animate-ticker whitespace-nowrap py-1.5 px-4">
              {[
                ...
                'Temperatura bate recorde histórico em São Luís: 38,7°C',
          ...
          <div className="flex items-center justify-between h-16">
            ...
            <Link href="/" className="flex items-center gap-2 group shrink-0">
              <div className="w-8 h-8 rounded bg-cyan flex items-center justify-center">
                <span className="font-headline font-bold text-base text-xs text-base">SL</span>
              </div>
            ...
            <div className="flex items-center gap-3">
              ...
              >
                ...
                <span className="hidden sm:block font-mono text-[10px] tracking-widest">⌘K</span>
              </button>
        ...
        <div className="fixed inset-0 z-[60] lg:hidden">
          ...
          <div className="absolute right-0 top-0 bottom-0 w-80 bg-surface border-l border-white/5 p-6 overflow-y-auto">
            <div className="flex items-center justify-between mb-8">
              ...
              <button onClick={() => setMenuOpen(false)} className="text-text-muted hover:text-text-primary">
      ...
      {searchOpen && (
        <div className="fixed inset-0 z-[70] flex items-start justify-center pt-[15vh] px-4">
          <div className="absolute inset-0 bg-base/85 backdrop-blur-md" onClick={() => setSearchOpen(false)} />
